...
Prerequisites for running the this project
...
3. Update application.properties file which is located on path src/main/resources
	...
	b. update following properties to replace localhost with hostip/hostname of docker container 
...
4. Open Postman and test aggregator service by hitting following end points
